  ...
  static getDerivedStateFromProps(props, state) {
    ...
    const scenes = props.routes.map((route, index, self) => {
      ...
      const {
        ...
        cardOverlayEnabled = Platform.OS !== 'ios' && optionsForTransitionConfig.presentation !== 'transparentModal' || cardStyleInterpolator === forModalPresentationIOS
      } = optionsForTransitionConfig;
      const headerMode = (_descriptor$options$h = descriptor.options.headerMode) !== null && _descriptor$options$h !== void 0 ? _descriptor$options$h : !(optionsForTransitionConfig.presentation === 'modal' || optionsForTransitionConfig.presentation === 'transparentModal' || (nextDescriptor === null || nextDescriptor === void 0 ? void 0 : nextDescriptor.options.presentation) === 'modal' || (nextDescriptor === null || nextDescriptor === void 0 ? void 0 : nextDescriptor.options.presentation) === 'transparentModal' || cardStyleInterpolator === forModalPresentationIOS) && Platform.OS === 'ios' && descriptor.options.header === undefined ? 'float' : 'screen';
      const scene = {
        route,
  ...
  render() {
    ...
    for (let i = scenes.length - 1; i >= 0; i--) {
      ...
      const {
        ...
        detachPreviousScreen = options.presentation === 'transparentModal' ? false : options.cardStyleInterpolator === forModalPresentationIOS ? i !== scenes.map(scene => scene.descriptor.options.cardStyleInterpolator).lastIndexOf(forModalPresentationIOS) : true
      } = options;
