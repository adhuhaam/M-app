...
function HeaderContainer({
  ...
  return /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
    ...
    const props = {
      ...
      styleInterpolator: mode === 'float' ? isHeaderStatic ? nextGestureDirection === 'vertical' || nextGestureDirection === 'vertical-inverted' ? _HeaderStyleInterpolators.forSlideUp : nextGestureDirection === 'horizontal-inverted' ? _HeaderStyleInterpolators.forSlideRight : _HeaderStyleInterpolators.forSlideLeft : headerStyleInterpolator : _HeaderStyleInterpolators.forNoAnimation
    };
