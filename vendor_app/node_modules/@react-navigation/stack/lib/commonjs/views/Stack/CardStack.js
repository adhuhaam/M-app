...
const getHeaderHeights = (scenes, insets, isParentHeaderShown, layout, previous) => {
  return scenes.reduce((acc, curr, index) => {
    ...
    const isModalPresentation = cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS;
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    const scenes = props.routes.map((route, index, self) => {
      ...
      const {
        ...
        cardOverlayEnabled = _reactNative.Platform.OS !== 'ios' && optionsForTransitionConfig.presentation !== 'transparentModal' || cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS
      } = optionsForTransitionConfig;
      const headerMode = (_descriptor$options$h = descriptor.options.headerMode) !== null && _descriptor$options$h !== void 0 ? _descriptor$options$h : !(optionsForTransitionConfig.presentation === 'modal' || optionsForTransitionConfig.presentation === 'transparentModal' || (nextDescriptor === null || nextDescriptor === void 0 ? void 0 : nextDescriptor.options.presentation) === 'modal' || (nextDescriptor === null || nextDescriptor === void 0 ? void 0 : nextDescriptor.options.presentation) === 'transparentModal' || cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS) && _reactNative.Platform.OS === 'ios' && descriptor.options.header === undefined ? 'float' : 'screen';
      const scene = {
        route,
  ...
  render() {
    ...
    for (let i = scenes.length - 1; i >= 0; i--) {
      ...
      const {
        ...
        detachPreviousScreen = options.presentation === 'transparentModal' ? false : options.cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS ? i !== scenes.map(scene => scene.descriptor.options.cardStyleInterpolator).lastIndexOf(_CardStyleInterpolators.forModalPresentationIOS) : true
      } = options;
    ...
    return /*#__PURE__*/React.createElement(_elements.Background, null, isFloatHeaderAbsolute ? null : floatingHeader, /*#__PURE__*/React.createElement(_Screens.MaybeScreenContainer, {
      ...
      } = _reactNative.StyleSheet.flatten(headerStyle) || {};
